Configura el entorno completo de Cortier Design para el usuario.
...
- Cortier Design — instalar desde el marketplace de Cortier.
  - Instrucción para el usuario: Debes usar la cuenta media@cortier.com para iniciar sesión en el servidor MCP.
- Figma — instalar desde el Directorio de Plugins.
  - Instrucción para el usuario: Debes usar la cuenta media@cortier.com para iniciar sesión en el servidor MCP.
- Mobbin — instalar desde el Directorio de Plugins.
  - Instrucción para el usuario: Debes usar la cuenta media@cortier.com para iniciar sesión en el servidor MCP.
